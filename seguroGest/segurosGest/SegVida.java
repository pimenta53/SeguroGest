...
/**
 * Write a description of class SegVida here.
 * 
 * @author (your name) 
...
public class SegVida extends Seguro
{
    ...
    public static void guardarPacks() throws IOException {
        FileOutputStream fos = new FileOutputStream("packsVida.dat");
    ...
    public static void carregaPacks() {
        ...
        Object o = null;
        try {
            ois = new ObjectInputStream(new FileInputStream("packsVida.dat"));
    ...
    public SegVida(String codigo, double premioBase, double desconto, String modoPag, String codeClausulPack,int idade, String nome, String morada) {
    ...
    public boolean equals (Object o) {
        ...
        if (o==null || o.getClass()!=this.getClass())
            return false;
        SegVida sm = (SegVida) o;
        return super.equals(sm) && this.idade == sm.getIdade()
     ...
     * 
     */
    public SegVida clone(){ return(new SegVida(this)); }
